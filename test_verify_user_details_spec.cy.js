...
describe('Test case is to verify User details through http requests', ()=> {
    ...
    it('Verify user details', ()=> {
        ...
        // cy.log(url+endPoint.user_details);
        // cy.visit(url);
        // cy.get('.url').scrollIntoView().click({force: true})
        // cy.get("body pre").then('user_details_received', ()=> {
        //     cy.log(user_details_received)
        // })
        // user_module.verifyUserDetails(url+endPoint.user_details)
